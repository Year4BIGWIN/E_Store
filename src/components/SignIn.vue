<template>
    <div class="w-[1024px] bg-[#d9d9d9] rounded-xl flex items-center justify-between">
      <!-- Left Image Section -->
      ...
      <div class="w-1/2 p-10 bg-[#f5f5f5] flex flex-col justify-center items-center rounded-xl">
        ...
        <form class="max-w-sm">
          ...
          <div class="flex justify-end mb-5">
            <router-link class="hover:text-blue-500" to="/login">Forget Password?</router-link>
          </div>
        ...
        <div class="my-5">
          ...
          <router-link class="hover:text-blue-500" to="/login">SignUp</router-link>
        </div>
