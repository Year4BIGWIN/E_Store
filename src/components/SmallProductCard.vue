<template>
  ...
  >
    <div class="relative aspect-square overflow-hidden">
      ...
      >
        <div
          class="transform translate-y-2 group-hover:translate-y-0 transition-transform"
        >
          <button
          ...
          >
            ...
            <svg
              v-else
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 animate-spin pointer-events-none"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
    ...
    <div class="flex flex-col justify-between flex-grow p-3 pt-2">
      <h3
        class="font-medium text-gray-800 mb-1 line-clamp-2 group-hover:text-blue-600 transition-colors"
      >
        {{ product.model }}
      </h3>
