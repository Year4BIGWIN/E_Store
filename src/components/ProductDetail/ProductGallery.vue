...
const activeTab = ref("images"); // 'images' or '3d'
  ...
  <div class="w-full flex flex-col gap-4">
    ...
    <div class="flex gap-2 border-b border-gray-200">
      <button
        ...
        :class="[
          'px-4 py-2 font-semibold text-sm md:text-base transition-all duration-200 border-b-2',
          activeTab === 'images'
    ...
    <!-- Images Tab Content -->
    <div v-show="activeTab === 'images'" class="w-full flex flex-col gap-4">
      <!-- Main image display -->
      <div
    ...
    <!-- 3D View Tab Content -->
    <div v-show="activeTab === '3d'" class="w-full flex flex">
       <div
        class="w-full relative group overflow-hidden rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 bg-white"
      >
        <img
