<template>
  <tr class="border-t border-gray-200 hover:bg-gray-50 transition-colors">
    ...
    <td class="p-4">
      <h3 class="w-[200px] font-semibold text-gray-800 line-clamp-1">
        {{ name }}
      </h3>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 max-w-md w-full">
      ...
      <div class="flex justify-end space-x-3">
        ...
        >
          ...
          <span v-else class="flex items-center"> Deleting... </span>
        </button>
      </div>
    </div>
  </div>
...
import defaultImage from "../assets/image/Logo-small.webp";
