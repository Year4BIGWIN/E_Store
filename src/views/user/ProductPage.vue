<template>
    ...
    <div class="w-screen justify-center items-center flex flex-col gap-10 py-10">
        <div class="w-[1152px] flex gap-4 font-semibold text-lg">
            <router-link ><span class="hover:text-blue-500">Home</span></router-link>
            <router-link >&#x2022 &nbsp &nbsp <span class="hover:text-blue-500">Product</span></router-link>
        </div>
            ...
            <div class="w-full flex gap-6 ">
                ...
                <div class="group bg-[#d9d9d9]  hover:bg-blue-500 hover:text-white hover:fill-white w-[275px] px-4 py-4 flex  items-center rounded-xl">
